...
See [undo transition sample](./samples/src/main/kotlin/ru/nsk/samples/UndoTransitionSample.kt)
...
2) Generation and processing of special `FinishedEvent`. This option is also available for composite states and useful
   ...
   See [transition on FinishedEvent sample](./samples/src/main/kotlin/ru/nsk/samples/FinishedEventSample.kt).
